							...
							<div class="doctor-widget">
								<div class="doc-info-left">
									<div class="doctor-img">
										<img src="{{asset('assets/img/doctors/'.$doctor->image)}}" class="img-fluid" alt="User Image">
									</div>
									<div class="doc-info-cont">
										<h4 class="doc-name">{{$doctor->user->name}}</h4>
										<p class="doc-department">{{$doctor->specialities}}</p>
										<div class="rating">
										...
										<div class="clinic-details">
											...
											<ul class="clinic-gallery">
												<li>
													...
													<a href="{{$doctor->facebook}}">Facebook</a>
												</li>
												<li>
													<i class="fab fa-twitter"></i>
													<a href="{{$doctor->twitter}}">Twitter</a>
												</li>
												<li>
													<i class="fab fa-linkedin"></i>
													<a href="{{$doctor->linkedin}}">Linkedin</a>
												</li>
												<li>
													<i class="fab fa-instagram"></i>
													<a href="{{$doctor->instagram}}">Instagram</a>
												</li>
												<li>
													<i class="fas fa-globe"></i>
													<a href="{{$doctor->personal_website}}">Personal Website</a>
												</li>											</ul>
										</div>
										<div class="clinic-booking">
										<a class="apt-btn col-md-5" href="{{route('bookDoctor',[$doctor->id,$doctor->user->name])}}">Book Appointment</a>
									</div>
									</div>
								</div>
								<div class="doc-info-right">
									<div class="clini-infos">
										<ul>
											...
											<li><i class="far fa-comment-alt"></i> 35 Feedback</li>
											<li><i class="fas fa-map-marker-alt"></i> Newyork, USA</li>
											<li>
												<i class="far fa-comment"></i> Chat : {{$doctor->chat}} TK
											</li>
											<li>
												<i class="fas fa-phone-alt"></i> Audio Call: {{$doctor->audio}} TK
											</li>
											<li>
												<i class="fas fa-video"></i> Video Call : {{$doctor->video}} TK
										...
										<div class="col-md-12 col-lg-9">
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	...
																	<span class="time">{{$value->year}}</span>
																</div>
															</div>
														</li>
														@endif
											...
											<div class="widget experience-widget">
												...
												<div class="experience-box">
													<ul class="experience-list">
														@foreach($profile as $value)
														@if($value->field=='Work & Experience')
														<li>
															<div class="experience-user">
																<div class="before-circle"></div>
															</div>
												...
												<div class="experience-box">
													<ul class="experience-list">
														...
														<li>
															...
															<div class="experience-content">
																<div class="timeline-content">
																	<p class="exp-year">{{$value->year}}</p>
																	<h4 class="exp-title">{{$value->title}}</h4>
											...
											<div class="service-list">
												...
												<ul class="clearfix">
													@foreach($profile as $value)
													@if($value->field=='Specializations')
													<li>{{$value->title}}</li>
													@endif
													@endforeach
												</ul>
